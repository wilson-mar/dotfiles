...
alias wmx='cd $HOME/gmail_acct/wilsonmar'
...
alias wmg='cd $HOME/gmail_acct/golang-samples'

alias mev='cd $HOME/McK-Enterprise-Automation/onefirmgithub-vault-scripts'
